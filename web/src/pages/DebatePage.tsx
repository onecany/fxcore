...
import type { DebateSession } from '../api/v1/types/contract';
    ...
    <section>
      ...
      <Panel title="会话列表" className="mb">
        <div className="table-wrap"><table className="data-table">
          <thead>
            <tr><th>名称</th><th>币种</th><th>状态</th><th>轮次</th><th>操作</th></tr>
          </thead>
          <tbody>
            {sessions.map((s) => (
              <tr key={s.id}>
            ...
            {sessions.length === 0 && <tr><td colSpan={5} className="empty">// NO DEBATES ON RECORD</td></tr>}
          </tbody>
        </table></div>
      </Panel>
